...
export const updateEntries = [
	{
		...
		title: '动态与收藏页面信息流设计',
		summary:
			'将动态和收藏从占位页推进为同骨架差异化页面：动态走时间线，收藏走精选与分组收藏板。',
	...
	},
	{
		...
		summary:
			'主页 dock 入口改为图标加描边字体，去掉圆形背景，让一级入口更接近当前 game UI 方向。',
	...
	},
	{
		...
		title: '归档底部选择滚动稳定性排查',
		summary:
			'继续跟踪 archive entry column 底部点击时的 reader rail 越界与布局跳动问题。',
	...
	},
	{
		...
		title: '标签页返回路径修正',
		summary:
			'顶部返回按钮跳过连续 tag 历史，回到进入标签页之前的非 tag 页面。',
	...
	},
	{
		...
		summary:
			'继续对齐 home mini player 与 footer 的左侧留白，确保 dock 偏移后整体重心仍然稳定。',
	...
	},
	{
		...
		summary:
			'将标签、收藏、动态与归档的 dock 图标整理为统一命名，减少静态资源引用的歧义。',
	...
	},
	{
		...
		summary:
			'收藏条目的 hover 从位移改为透明度驱动的渐变光效，保留全局按压缩放作为统一交互反馈。',
	...
	},
	{
		...
		title: '归档分类切换滚动复测',
		summary:
			'为归档页分类切换准备更长列表场景，复测底部起始位置下 viewport 是否发生瞬时越界。',
	...
	},
	{
		...
		title: '信息流密度与卡片尺寸调校',
		summary:
			'用更长的动态数据检查 timeline 在桌面和移动端的节奏、卡片间距与滚动舒适度。',
	...
	},
	{
		...
		summary:
			'通过动态页长列表验证 ScrollChrome 在 subpage shell 内的高度计算、滚动条与内容裁切。',
	...
	},
	{
		...
		title: '公开页文案层级清理',
		summary:
			'整理动态与收藏页里不需要的标题模板和说明文本，避免小型 eyebrow 风格回流。',
