...
const manageErrorMessageKeys: Record<string, string> = {
	...
	record_list_load_failed: 'manage.errors.recordListLoadFailed',
	record_load_failed: 'manage.errors.recordLoadFailed',
	record_not_found: 'manage.errors.recordNotFound',
	duplicate_record_id: 'manage.errors.duplicateRecordId',
	invalid_record: 'manage.errors.invalidRecord',
	invalid_record_kind: 'manage.errors.invalidRecordKind',
	invalid_record_id: 'manage.errors.invalidRecordId',
	invalid_group: 'manage.errors.invalidGroup',
	invalid_group_id: 'manage.errors.invalidGroupId',
	invalid_group_kind: 'manage.errors.invalidGroupKind',
	invalid_group_name: 'manage.errors.invalidGroupName',
	group_not_found: 'manage.errors.groupNotFound',
	duplicate_group_name: 'manage.errors.duplicateGroupName',
	duplicate_group_id: 'manage.errors.duplicateGroupId',
	missing_group_name: 'manage.errors.missingGroupName',
